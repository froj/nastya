...
# Includes the BSP.
ALT_INCLUDE_DIRS := .
ALT_INCLUDE_DIRS += modules/modules
ALT_INCLUDE_DIRS += modules/modules/blocking_detection_manager
ALT_INCLUDE_DIRS += modules/modules/control_system_manager
ALT_INCLUDE_DIRS += modules/modules/cvra_adc
ALT_INCLUDE_DIRS += modules/modules/cvra_beacon
ALT_INCLUDE_DIRS += modules/modules/cvra_dc
ALT_INCLUDE_DIRS += modules/modules/cvra_pio
ALT_INCLUDE_DIRS += modules/modules/cvra_servo
ALT_INCLUDE_DIRS += modules/modules/error
ALT_INCLUDE_DIRS += modules/modules/json
ALT_INCLUDE_DIRS += modules/modules/math
ALT_INCLUDE_DIRS += modules/modules/obstacle_avoidance
ALT_INCLUDE_DIRS += modules/modules/param
ALT_INCLUDE_DIRS += modules/modules/pid
ALT_INCLUDE_DIRS += modules/modules/platform
ALT_INCLUDE_DIRS += modules/modules/position_manager
ALT_INCLUDE_DIRS += modules/modules/quadramp
ALT_INCLUDE_DIRS += modules/modules/ramp
ALT_INCLUDE_DIRS += modules/modules/robot_base_mixer
ALT_INCLUDE_DIRS += modules/modules/robot_system
ALT_INCLUDE_DIRS += modules/modules/trace
ALT_INCLUDE_DIRS += modules/modules/trajectory_manager
ALT_INCLUDE_DIRS += modules/modules/uptime
ALT_INCLUDE_DIRS += modules/modules/math/geometry
ALT_INCLUDE_DIRS += modules/modules/math/fast_math
ALT_INCLUDE_DIRS += modules/modules/math/vect2/
ALT_INCLUDE_DIRS += modules/include/
ALT_INCLUDE_DIRS += lua
ALT_INCLUDE_DIRS += lwip_ucos2/src/include
ALT_INCLUDE_DIRS += lwip_ucos2/src/include/ipv4
ALT_INCLUDE_DIRS += lwip_ucos2/src/include/ipv6
ALT_INCLUDE_DIRS += lwip_ucos2/src/contrib/ports/ucos-ii/include
ALT_INCLUDE_DIRS += lwip_ucos2/src/include/posix
...
C_SRCS += control.c
C_SRCS += drive.c
C_SRCS += drive_open_loop_dynamic_path.c
C_SRCS += drive_waypoint.c
C_SRCS += encoder_readout_task.c
C_SRCS += hardware.c
C_SRCS += imu.c
C_SRCS += imu_readout_task.c
C_SRCS += init_.c
C_SRCS += lua_console.c
C_SRCS += main.c
C_SRCS += match.c
C_SRCS += obstacle_avoidance_protocol.c
C_SRCS += plot_task.c
C_SRCS += position_integration.c
C_SRCS += serial_datagram.c
C_SRCS += serial_io.c
C_SRCS += util.c
C_SRCS += modules/modules/blocking_detection_manager/blocking_detection_manager.c
C_SRCS += modules/modules/control_system_manager/control_system_manager.c
C_SRCS += modules/modules/cvra_adc/cvra_adc.c
C_SRCS += modules/modules/cvra_beacon/cvra_beacon.c
C_SRCS += modules/modules/cvra_dc/cvra_dc.c
C_SRCS += modules/modules/cvra_pio/cvra_pio.c
C_SRCS += modules/modules/cvra_servo/cvra_servo.c
C_SRCS += modules/modules/error/error.c
C_SRCS += modules/modules/json/json.c
C_SRCS += modules/modules/param/param.c
C_SRCS += modules/modules/pid/pid.c
C_SRCS += modules/modules/platform/platform_nios2.c
C_SRCS += modules/modules/quadramp/quadramp.c
C_SRCS += modules/modules/ramp/ramp.c
C_SRCS += modules/modules/robot_base_mixer/robot_base_holonomic_mixer.c
C_SRCS += modules/modules/trace/trace.c
C_SRCS += modules/modules/trace/trace_over_ip.c
C_SRCS += modules/modules/uptime/uptime.c
C_SRCS += lwip_ucos2/src/api/api_lib.c
C_SRCS += lwip_ucos2/src/api/api_msg.c
C_SRCS += lwip_ucos2/src/api/err.c
C_SRCS += lwip_ucos2/src/api/netbuf.c
C_SRCS += lwip_ucos2/src/api/netdb.c
C_SRCS += lwip_ucos2/src/api/netifapi.c
C_SRCS += lwip_ucos2/src/api/sockets.c
C_SRCS += lwip_ucos2/src/api/tcpip.c
C_SRCS += lwip_ucos2/src/contrib/ports/ucos-ii/lib.c
C_SRCS += lwip_ucos2/src/contrib/ports/ucos-ii/sys_arch.c
C_SRCS += lwip_ucos2/src/core/ipv4/autoip.c
C_SRCS += lwip_ucos2/src/core/ipv4/icmp.c
C_SRCS += lwip_ucos2/src/core/ipv4/igmp.c
C_SRCS += lwip_ucos2/src/core/ipv4/ip4.c
C_SRCS += lwip_ucos2/src/core/ipv4/ip4_addr.c
C_SRCS += lwip_ucos2/src/core/ipv4/ip_frag.c
C_SRCS += lwip_ucos2/src/core/def.c
C_SRCS += lwip_ucos2/src/core/dhcp.c
C_SRCS += lwip_ucos2/src/core/dns.c
C_SRCS += lwip_ucos2/src/core/inet_chksum.c
C_SRCS += lwip_ucos2/src/core/init.c
C_SRCS += lwip_ucos2/src/core/mem.c
C_SRCS += lwip_ucos2/src/core/memp.c
C_SRCS += lwip_ucos2/src/core/netif.c
C_SRCS += lwip_ucos2/src/core/pbuf.c
C_SRCS += lwip_ucos2/src/core/raw.c
C_SRCS += lwip_ucos2/src/core/stats.c
C_SRCS += lwip_ucos2/src/core/sys.c
C_SRCS += lwip_ucos2/src/core/tcp.c
C_SRCS += lwip_ucos2/src/core/tcp_in.c
C_SRCS += lwip_ucos2/src/core/tcp_out.c
C_SRCS += lwip_ucos2/src/core/timers.c
C_SRCS += lwip_ucos2/src/core/udp.c
C_SRCS += lwip_ucos2/src/netif/slipif.c
C_SRCS += lwip_ucos2/src/netif/etharp.c
C_SRCS += lwip_ucos2/src/netif/ethernetif.c
C_SRCS += lua/lapi.c
C_SRCS += lua/lauxlib.c
C_SRCS += lua/lbaselib.c
C_SRCS += lua/lbitlib.c
C_SRCS += lua/lcode.c
C_SRCS += lua/lcorolib.c
C_SRCS += lua/lctype.c
C_SRCS += lua/ldblib.c
C_SRCS += lua/ldebug.c
C_SRCS += lua/ldo.c
...
C_SRCS += lua/linit.c
C_SRCS += lua/llex.c
C_SRCS += lua/lmathlib.c
C_SRCS += lua/lmem.c
C_SRCS += lua/lobject.c
C_SRCS += lua/lopcodes.c
C_SRCS += lua/lparser.c
C_SRCS += lua/lstate.c
C_SRCS += lua/lstring.c
C_SRCS += lua/lstrlib.c
C_SRCS += lua/ltable.c
C_SRCS += lua/ltablib.c
C_SRCS += lua/ltm.c
C_SRCS += lua/lundump.c
C_SRCS += lua/lvm.c
C_SRCS += lua/lzio.c
CXX_SRCS :=
ASM_SRCS :=
...
BSP_ROOT_DIR := ../nios_files/software/nastya_bsp/
